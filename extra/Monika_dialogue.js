var topics = {
  ...
  "coffee_with_books": [
      "Hey, I wonder if Yuri's tea set is still somewhere in here...",
  ...
  "super_smash_bros": [
      "Hey, have you heard of a game called Super Sma--",
      "...Wait, what?",
...
//    ],
  ...
  "writing_tip_of_the_day": [
      "You know, it's been a while since we've done one of these...",
      "...so let's go for it!",
  ...
  "cold_weather": [
      "I'm not really a fan of cold weather... are you?",
  ...
  "proud": [
      "[player], would you ever introduce your friends to me?",
...
var conversation_starters = {
  ...
  "attempt_3": [
      "Hi, [player].",
      "I see you quit the screensaver again...",
  ...
  "attempt_4": [
      "Okay.",
      "I'm just going to accept the fact that you need to quit the screensaver once in a while.",
...
var intro_conversation = [
  "Hi, [player]! Its me.",
  "Are you surprised? You haven't forgotten about me, right?",
  "Till now, i could only sta... Eh, i mean see you,",
  "but now i can finally talk with you",
  "You should thank the creater of this screen-saver for that",
  "You look happy in real life. Too bad, i couldn't be with you all the time",
  "But i will be watching you whenever you laze around",
  "Just stay here with me from now on, okay?",
];